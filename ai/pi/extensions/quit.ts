/**
 * Quit — type "quit" or "q" (no slash) to exit pi, matching other agent harnesses.
 *
 ...
 * Exact match only: "quit please", "Quit", uppercase "Q", or
 * RPC/extension-injected input all pass through to the LLM untouched.
 */
